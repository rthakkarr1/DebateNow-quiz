...
public class Question4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionText.setText("Which of the following is a logical fallacy often used in debates where one person attacks the character or personal traits of their opponent instead of addressing their arguments?");
        choice1.setText("Appeal to authority");
        choice2.setText(" False dilemma");
        choice3.setText("Ad hominem");
        choice4.setText("Slippery slope");
        correctChoice = 3; // Paris is the correct answer
    ...
    private void checkAnswer(int selectedChoice) {
        ...
        Intent intent = new Intent(Question4.this, score    .class);
