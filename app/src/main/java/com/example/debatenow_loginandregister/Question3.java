...
public class Question3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionText.setText("What is the term used to describe a debate where one side argues in favor of a proposition and the other side argues against it?");
        choice1.setText("Lincoln-Douglas");
        choice2.setText("Oxford");
        choice3.setText("Parliamentary");
        choice4.setText("Propositional");
